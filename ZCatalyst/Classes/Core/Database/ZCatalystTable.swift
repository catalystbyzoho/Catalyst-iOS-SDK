//
//  ZCatalystTable.swift
//  Pods
//
//  Created by Senthilkumar Selvaraj on 19/12/25.
//

import Foundation

public struct ZCatalystTable{
    ...
    internal func getColumns( completion : @escaping ( Result< [ ZCatalystColumn ], ZCatalystError > ) -> Void )
    {
